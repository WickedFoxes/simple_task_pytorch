...
_AUG_MAP = {
  ...
  "RandomResizedCrop": lambda **p: transforms.RandomResizedCrop(p["size"], scale=p.get("scale", (0.08, 1.0)), ratio=p.get("ratio", (3./4., 4./3.)), interpolation=p.get("interpolation", transforms.InterpolationMode.BILINEAR)),
